...
! function(a, b) {
    ...
    p.alert = function() {
        ...
        return a.placeholder && h.attr("placeholder", a.placeholder), a.pattern && h.attr("pattern", a.pattern), a.maxlength && h.attr("maxlength", a.maxlength), f.append(h), f.on("submit", function(a) {
            a.preventDefault(), a.stopPropagation(), e.find(".btn-default").click()
        ...
        if (g(j, function(a,b) {
            ...
            "ancho-mediano" === a.size ? f.addClass("ancho-mediano") : "ancho-peque̱o" === a.size && f.addClass("ancho-peque̱o"), 
            "ancho-combo" === a.size ? f.addClass("ancho-combo") : "ancho-peque̱o" === a.size && f.addClass("ancho-peque̱o"), 
            "ancho-masGrande" === a.size ? f.addClass("ancho-masGrande") : "ancho-peque̱o" === a.size && f.addClass("ancho-peque̱o"), 
