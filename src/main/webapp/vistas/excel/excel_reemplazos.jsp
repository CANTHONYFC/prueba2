...
<%
		...
		JSONObject jsonlistado = srv.reporteExcel(json);
...
<tr>
			...
			<tr> 
				...
				<td width='200' <%=borderColorTitulo%> align='center'>FECHA DE PROGRAMACIÓN</td>
				<td width='200' <%=borderColorTitulo%> align='center'>SEDES</td>
				<td width='200' <%=borderColorTitulo%> align='center'>PROGRAMACIÓN DICÓN</td>
				<td width='200' <%=borderColorTitulo%> align='center'>MODO MARCACIÓN</td>
...
String VALIDARHUELLA=obj.get("10").toString();
	...
	if(VALIDARHUELLA.equals("H"))
		{
			MODO="HUELLA";
	}	if(VALIDARHUELLA.equals("M"))
		{
			MODO="MANUAL";
	}
if(VALIDARHUELLA.equals("?"))
		{
			MODO="SIN HUELLA";
	}
