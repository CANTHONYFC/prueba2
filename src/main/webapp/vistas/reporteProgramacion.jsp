		...
		<div class="row wrapper border-bottom blue-bg page-heading" style="background-color:#2c986f; ">
			<div class="col-lg-9" style="background-color:#2c986f; ">
				<ol class="breadcrumb" style="background-color:#2c986f;">
					...
					<li class="active">
						<strong>Reporte Programación</strong>
					</li>
				</ol>
			</div>
		</div>
...
<label>Fecha Fin </label> <span class="text-danger">(*)</span>n
                                        ...
                                        <div id="divCboEstado">
                                            <select class="form-control" id="cbEstado"  name="cbEstado" >
                                                ...
                                                <option  value="2">MODIFICADO</option>
															...
															<div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group" id="divInputFiltro">
                                        <label>Modo Marcación</label> <span class="text-danger">(*)</span> 
                                        <div id="divCboEstado">
                                            <select class="form-control" id="cbModoMarcacion"  name="cbEstado" >
                                                <option  value="H">HUELLA</option>
                                                <option  value="M">CÓDIGO</option>
																								 <option  value="?">SIN HUELLA</option>
	...
	<div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins shadow-material">
                    <div class="ibox-title" >
                        <h5>Reporte de Programaciones</h5>
                        <div class="ibox-tools">
										...
										<table id="tbListadoPersonal" class="table table-striped table-bordered table-hover cell-border" >
											<thead>
												<tr>
													...
													<th class="cabecera"  style="text-align: center">FECHA PROGRAMACIÓN</th>
...
<script src="../js/pages/ListadoProgramaciones.js"></script>
<script src="../js/pages/reporteExcel.js"></script>
