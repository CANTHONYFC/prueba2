    ...
    c.prototype.listen = function() {
        ...
        if (this.$preview.length > 0 && ("undefined" != typeof d.type ? d.type.match(/^image\/(gif|png|jpeg)$/) : d.name.match(/\.(gif|png|jpe?g)$/i)) && "undefined" != typeof FileReader) {
            var e = new FileReader,
                ...
                g = this.$element;
            e.onload = function(b) {
                var e = a("<img id='foto' style='width: 170px !important; height: 180px!important;object-fit: cover !important;'>");
...
//    alert();
        ...
        var imagencita = "<img id='foto' src=''>";
        this.$preview.html(imagencita), 
        this.$element.find(".fileinput-filename").text(""),
        this.$element.addClass("fileinput-new").removeClass("fileinput-exists"), void 0 !== a && (this.$input.trigger("change"), this.$element.trigger("clear.bs.fileinput"))
