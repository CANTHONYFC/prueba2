...
//            dateISO: "Por favor introduzca una fecha válida ( ISO ).",
            dateISO: "Por favor introduzca una fecha válida.",
            number: "Por favor ingrese un número válido.",
            digits: "Por favor ingrese solo dígitos.",
            creditcard: "Por favor, introduzca un número de tarjeta de crédito válido.",
            equalTo: "Por favor, introduzca el mismo valor de nuevo.",
            maxlength: a.validator.format("Por favor, introduzca no más de {0} caracteres."),
            minlength: a.validator.format("Introduzca  {0} caracteres."),
            rangelength: a.validator.format("Introduzca un valor entre {0} y {1} caracteres largos."),
            range: a.validator.format("Introduzca un valor {0} y {1}."),
            max: a.validator.format("Ingrese un valor menor o igual a {0}."),
            min: a.validator.format("Ingrese un valor mayor o igual que {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
...
//                return this.optional(b) || /^([0][1-9]|[12][0-9]|3[01])[\/\-]([0][1-9]|[1][0-2])\2(\d{4})$/.test(a)
